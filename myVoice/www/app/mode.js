...
function mode_photo(){
    ...
    $("#photo_grid_C").append("<div><img id='selectedForImport' src='app/img/capture.png' onclick='popup_import()'/></div>");
    $("#photo_grid_E").append("<div><img src='app/img/sound.png' onclick='captureAudio()' /></div>");
    $("#photo_grid_D").append("<input type='text' id='newPicName' style='width:100%; height:40%;'><input type='submit' value='Submit' style='width:100%; height:40%;'>");
