...
function mode_admin(){
    ...
    $("#admin_left").append("<div class='cheader' style='width:100%; height:10%;'></div><div class='cheader' style='width:100%; height:10%;' onclick='reorganisation_tab_admin(1);'></div><div class='ccontent' style='width:100%; height:72%;'></div><div class='cfooter' style='width:100%; height:8%;'></div>");
    ...
    $("#admin_right").append("<div class='cheader' style='width:100%; height:10%;'></div><div class='cheader' style='width:100%; height:10%;' onclick='reorganisation_tab_admin(0);'></div><div class='ccontent' style='width:100%; height:72%;'></div><div class='cfooter' style='width:100%; height:8%;'></div>");
