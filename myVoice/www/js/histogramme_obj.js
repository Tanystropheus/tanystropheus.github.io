...
function	make_background(group, from, to, elemid, hat, color)
{
	...
	// console.log("Youypiiiiiiii  		8****88");
		...
		txt.content = all_elem[elemid].taglst;
		// console.log(txt.fontSize);
		// console.log(txt.fontWidth);
		// console.log(txt.leading);

		var max_txt = (((width - 2 * marge) * 2) / nb_lettre_min);
		// console.warn(max_txt);

		// console.log("width:"+width);
		// console.log("length:"+txt.content.length);
		// console.log((width / txt.content.length));
		...
		// txt.fontWidth = 20;
		// var txt = new PointText(new Point(/*ici on met l'espace dans lequel 	*/));


		// console.log("width img:"+all_elem[elemid]['width']);
		// console.log("width:"+width);


		img.source = all_elem[elemid]['elemurl'];
		img.position = new Point((from.x + to.x) / 2, from.y + (to.y - from.y) / 2 - width * (1 - coef) + marge * 1.5);
