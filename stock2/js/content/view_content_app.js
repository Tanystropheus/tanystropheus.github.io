...
function show_img()
{
    ...
    for (var img in tmp_images){
        if (tmp_images.hasOwnProperty(img))
            document.getElementById("img_"+(++nb_img)).innerHTML = "<span class='img_frame' id='frame_"+img+"'><span id='s_"+img+"'><img id='"+img+"' src='"+img+"'/></span></span>";       
...
function add_one(){
    ...
    {
        $("#voice_image").append("<li><span class='img_frame'></span></li>");
    }
}
